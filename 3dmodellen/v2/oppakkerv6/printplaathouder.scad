...
// rand voor verhoging
        translate([
            -motor_breedte/2+rand_marge_kleiner-extra_breedte+20,
            -motor_lengte-motor_lengte/2-lengte_ruimte_tussen_2_motoren+rand_marge_kleiner-extra_lengte_voor_en_achter-extra_lengte/2+30,
            hoogte_verdikking
        ]){
            cube([
            10,
        ...
        translate([
            -motor_breedte/2+rand_marge_kleiner-extra_breedte+60,
            -motor_lengte-motor_lengte/2-lengte_ruimte_tussen_2_motoren+rand_marge_kleiner-extra_lengte_voor_en_achter-extra_lengte/2+30,
            hoogte_verdikking
        ]){
            cube([
...
// gaten voor magneet snoeren
        translate([motor_breedte/2+breedte_ruimte_tussen_2_motoren/2-4+10+7,-64.6+2,-1]){
            cube([8,3,15], center=false);
        }         
        translate([motor_breedte/2+breedte_ruimte_tussen_2_motoren/2-4+10+7,-64.6-0.5,-1]){
            cube([3,3,15], center=false);
        }         

        translate([motor_breedte/2+breedte_ruimte_tussen_2_motoren/2-4+10+7,32.2-2,-1]){
            cube([8,3,15], center=false);
        }         
        translate([motor_breedte/2+breedte_ruimte_tussen_2_motoren/2-4+10+7,32.2+0.5,-1]){
            cube([3,3,15], center=false);
        }         
...
//gaten voor motage blok
        translate([motor_breedte/2+breedte_ruimte_tussen_2_motoren/2-10,-64.6+6,-1]){
                cylinder(h=117, r=1.2, $fn=100, center=false);
        }         
        translate([motor_breedte/2+breedte_ruimte_tussen_2_motoren/2+10,-64.6+6,-1]){
                cylinder(h=117, r=1.2, $fn=100, center=false);
        }         
        translate([motor_breedte/2+breedte_ruimte_tussen_2_motoren/2-10,-64.6+6+afstand_tussen_print_gaten,-1]){
                cylinder(h=117, r=1.2, $fn=100, center=false);
        }         
        translate([motor_breedte/2+breedte_ruimte_tussen_2_motoren/2+10,-64.6+6+afstand_tussen_print_gaten,-1]){
                cylinder(h=117, r=1.2, $fn=100, center=false);
